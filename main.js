...
function populateCardPlus(event){
        ...
        titleName.innerHTML= formatName(users[currentPersonIndex].name)
        
        pictureHolder.setAttribute("src",users[currentPersonIndex].picture.large)
        
        emailHolder.innerHTML=users[currentPersonIndex].email
        
        phoneHolder.innerHTML=users[currentPersonIndex].phone
...
function populateCardMinus(event){
        ...
        let phoneHolder = document.querySelector(".phone")
        phoneHolder.innerHTML=users[currentPersonIndex].phone
...
//Det som laddas in från start

let titleName = document.querySelector(".name")
titleName.innerHTML= formatName(users[currentPersonIndex].name)

let pictureHolder = document.querySelector("img")
pictureHolder.setAttribute("src",users[currentPersonIndex].picture.large)
...
btnPrev.addEventListener('click', populateCardMinus);

let btnNext = document.querySelector(".next");
btnNext.addEventListener('click',populateCardPlus);
